...
class BuyButton(discord.ui.Button):
    def __init__(self, view: ShopView, item_type: str, item_name: str, price_cash: int, price_melones: int, style=discord.ButtonStyle.green):
        super().__init__()
        ...
        self.label = f"{price_cash}🥥 {price_melones}🍉" 
    ...
    def update_view(self):
        ...
        for pack_name in packs:
            ...
            section = discord.ui.Section(
                discord.ui.TextDisplay(content=f"🃏 **{pack_name}**"),
                accessory=BuyButton(
                    view=self,
                    item_type="pack",
                    item_name=pack_name,
        ...
        self.shop_btn.disabled = self.current_shop == "daily"
        self.daily_btn.disabled = self.current_shop == "shop"
    ...
    async def buy(self, interaction: discord.Interaction, item_type: str, item_name: str, item_price_cash: int, item_price_melones: int):
        ...
        try:
            if item_type == "pack":
                ...
                self.datadriver.set_user_packs(self.author_id, user_cards)
